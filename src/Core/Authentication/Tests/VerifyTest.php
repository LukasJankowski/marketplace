...
class VerifyTest extends TestCase
{
    ...
    public function testCanVerifyUser()
    {
        ...
        $url = URL::signedRoute('marketplace.core.authentication.verify', ['id' => $u->id]);
    ...
    {
        $url = URL::signedRoute('marketplace.core.authentication.verify', ['id' => 1]);

        $this->getJson($url)
            ->assertStatus(403)
            ->assertJsonPath('data.message', 'marketplace.core.authentication.verification.invalid');
    }
}
