...
class PasswordTest extends TestCase
{
    ...
    public function testCanUpdatePasswordOfUser()
    {
        ...
        $url = URL::signedRoute('marketplace.core.authentication.password', ['role' => 'customer', 'id' => $u->id]);
    ...
    {
        $url = URL::signedRoute('marketplace.core.authentication.password', ['role' => 'customer', 'id' => 1]);

        $this->postJson($url, ['password' => 'another'])
            ->assertStatus(403)
            ->assertJsonPath('data.message', 'marketplace.core.authentication.password.invalid');
    }
